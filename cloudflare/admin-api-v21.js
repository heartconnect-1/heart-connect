import {handleAdmin as handleAdminV20,runPhase7AndEarlierScheduled} from './admin-api-v20.js';
import {adminHtml} from './admin-ui-v21.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v21.1';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV20(request,env);
}
