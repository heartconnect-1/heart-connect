import {handleAdmin as handleAdminV29,runPhase7AndEarlierScheduled} from './admin-api-v29.js';
import {adminHtml} from './admin-ui-v30.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v30';

function page(html,head=false){
  const headers={
    'content-type':'text/html; charset=utf-8','cache-control':'no-store, max-age=0','pragma':'no-cache',
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV29(request,env);
}
