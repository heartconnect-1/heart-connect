import {handleAdmin as handleAdminV22,runPhase7AndEarlierScheduled} from './admin-api-v22.js';
import {adminHtml} from './admin-ui-v23.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v23';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV22(request,env);
}
