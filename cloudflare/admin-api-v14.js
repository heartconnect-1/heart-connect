import {handleAdmin as handleAdminV13,runPhase7AndEarlierScheduled} from './admin-api-v13.js';
import {adminHtml} from './admin-ui-v14.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v14';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV13(request,env);
}
