import {handleAdmin as handleAdminV25,runPhase7AndEarlierScheduled} from './admin-api-v25.js';
import {adminHtml} from './admin-ui-v26.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v26';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV25(request,env);
}
