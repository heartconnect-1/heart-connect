import {handleAdmin as handleAdminV32,runPhase7AndEarlierScheduled} from './admin-api-v32.js';
import {adminHtml} from './admin-ui-v33.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v33';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV32(request,env);
}
