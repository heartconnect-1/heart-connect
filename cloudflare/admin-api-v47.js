import {handleAdmin as handleAdminV46,runPhase7AndEarlierScheduled} from './admin-api-v46.js';
import {adminHtml} from './admin-ui-v47.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v47';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV46(request,env);
}
