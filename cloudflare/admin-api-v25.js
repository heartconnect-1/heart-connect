import {handleAdmin as handleAdminV24,runPhase7AndEarlierScheduled} from './admin-api-v24.js';
import {adminHtml} from './admin-ui-v25.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v25';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV24(request,env);
}
