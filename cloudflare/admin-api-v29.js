import {handleAdmin as handleAdminV28,runPhase7AndEarlierScheduled} from './admin-api-v28.js';
import {adminHtml} from './admin-ui-v29.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v29';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV28(request,env);
}
