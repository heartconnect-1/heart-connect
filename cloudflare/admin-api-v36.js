import {handleAdmin as handleAdminV35,runPhase7AndEarlierScheduled} from './admin-api-v35.js';
import {adminHtml} from './admin-ui-v36.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v36';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV35(request,env);
}
