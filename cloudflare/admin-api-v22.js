import {handleAdmin as handleAdminV21,runPhase7AndEarlierScheduled} from './admin-api-v21.js';
import {adminHtml} from './admin-ui-v22.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v22';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV21(request,env);
}
