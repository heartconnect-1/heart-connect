import {handleAdmin as handleAdminV17,runPhase7AndEarlierScheduled} from './admin-api-v17.js';
import {adminHtml} from './admin-ui-v18.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v18';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV17(request,env);
}
