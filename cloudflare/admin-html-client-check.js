...
import {adminHtml} from './admin-ui-v24.js';

const html=adminHtml('hc-admin-control-plane-v24-test');
...
console.log(`Compiled ${scripts.length} admin inline scripts and verified v24 overview, interests, gender and location controls.`);
