...
import {adminHtml} from './admin-ui-v28.js';

const html=adminHtml('hc-admin-control-plane-v28-test');
...
console.log(`Compiled ${scripts.length} admin inline scripts and verified v28 verification, moderation, analytics, overview, interests, gender and location controls.`);
