...
import {adminHtml} from './admin-ui-v32.js';

const html=adminHtml('hc-admin-control-plane-v32-test');
...
for(const marker of ['Advanced Verification Center','Advanced Payment Operations','Advanced Market Control','Advanced Content Studio','Featured image / cover','Category','Tags','Visual editor','Search preview','Save draft','Schedule post','Publish now','Autosave ready','min read']){
...
console.log(`Compiled ${scripts.length} admin inline scripts and verified v32 professional CMS editor plus prior admin layers.`);
