...
import {adminHtml} from './admin-ui-v27.js';

const html=adminHtml('hc-admin-control-plane-v27-test');
...
for(const marker of ['Media & HTML sections','Post media uploads','+ Add User','Profile editor','Discover visibility','Upload profile photo','AI admin assistant','Back to Users','Location & discovery','Save location','✦ AI Help','Heart Connect Admin AI','Profile photos','hc19AddPhotos','Mapbox place picker','Search Mapbox','hc16AddGender','hc16Gender','Select gender','📍 Nearby','🌍 Global','Maximum distance','Choose from country and city lists instead','Member location','hc21-location-shell','Choose interests','hc22-interest-box','Multiple selections are allowed','Heart Connect control center','Needs your attention','Platform operations','Launch readiness','AI management brief','Platform Analytics','Privacy-safe analytics','Platform activity','Operational activity','Showing the last','Advanced Platform Analytics','Period-over-period growth','Engagement & trust ratios','Operations pulse','AI analytics analyst','Generate insight','Advanced Moderation','Trust & safety command center','Moderation queue','Report categories','AI moderation assistant','Human review is required','Quick actions','+ Add user','hc24-overview','Needs your attention','Platform operations','Launch readiness','AI management brief']){
...
console.log(`Compiled ${scripts.length} admin inline scripts and verified v27 moderation, advanced analytics, overview, interests, gender and location controls.`);
