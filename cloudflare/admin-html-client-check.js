...
import {adminHtml} from './admin-ui-v25.js';

const html=adminHtml('hc-admin-control-plane-v25-test');
...
console.log(`Compiled ${scripts.length} admin inline scripts and verified v25 overview, analytics, interests, gender and location controls.`);
