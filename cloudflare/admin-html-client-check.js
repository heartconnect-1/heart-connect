...
import {adminHtml} from './admin-ui-v26.js';

const html=adminHtml('hc-admin-control-plane-v26-test');
...
console.log(`Compiled ${scripts.length} admin inline scripts and verified v26 advanced analytics, overview, interests, gender and location controls.`);
