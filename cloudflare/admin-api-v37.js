import {handleAdmin as handleAdminV36,runPhase7AndEarlierScheduled} from './admin-api-v36.js';
import {adminHtml} from './admin-ui-v37.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v37';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV36(request,env);
}
