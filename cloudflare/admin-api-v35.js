import {handleAdmin as handleAdminV34,runPhase7AndEarlierScheduled} from './admin-api-v34.js';
import {adminHtml} from './admin-ui-v35.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v35';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV34(request,env);
}
