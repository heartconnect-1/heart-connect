import {handleAdmin as handleAdminV10,runPhase7AndEarlierScheduled} from './admin-api-v10.js';
import {adminHtml} from './admin-ui-v11.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v11';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV10(request,env);
}
