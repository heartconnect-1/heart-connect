...
import {handleAdmin,runPhase6AndPhase5Scheduled,VERSION as ADMIN_VERSION} from './admin-api-v6.js';

const EDGE_VERSION='cloudflare-admin-router-v6';
...
export default {
  ...
  async scheduled(controller,env,ctx){
    const jobs=[runPhase6AndPhase5Scheduled(env)];
