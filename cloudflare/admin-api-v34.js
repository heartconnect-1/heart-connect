import {handleAdmin as handleAdminV33,runPhase7AndEarlierScheduled} from './admin-api-v33.js';
import {adminHtml} from './admin-ui-v34.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v34';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV33(request,env);
}
