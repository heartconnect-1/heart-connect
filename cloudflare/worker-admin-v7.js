...
import {handleAdmin,runPhase7AndEarlierScheduled,VERSION as ADMIN_VERSION} from './admin-api-v26.js';
import {handleAdminLogin} from './admin-login-v2.js';

const EDGE_VERSION='cloudflare-admin-router-v26-advanced-analytics';
