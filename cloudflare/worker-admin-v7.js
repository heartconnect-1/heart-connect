...
import {handleAdmin,runPhase7AndEarlierScheduled,VERSION as ADMIN_VERSION} from './admin-api-v15.js';
import {handleAdminLogin} from './admin-login-v2.js';

const EDGE_VERSION='cloudflare-admin-router-v15-visible-uploads';
