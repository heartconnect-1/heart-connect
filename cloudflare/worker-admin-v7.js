...
import {handleAdmin,runPhase7AndEarlierScheduled,VERSION as ADMIN_VERSION} from './admin-api-v36.js';
import {handleAdminLogin} from './admin-login-v2.js';
import BOOKING_ADVANCED from './booking-advanced-v10.txt';

const EDGE_VERSION='cloudflare-admin-router-v37-notification-control-center';
