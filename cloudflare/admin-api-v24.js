import {handleAdmin as handleAdminV23,runPhase7AndEarlierScheduled} from './admin-api-v23.js';
import {adminHtml} from './admin-ui-v24.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v24';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV23(request,env);
}
