import {handleAdmin as handleAdminV27,runPhase7AndEarlierScheduled} from './admin-api-v27.js';
import {adminHtml} from './admin-ui-v28.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v28';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV27(request,env);
}
