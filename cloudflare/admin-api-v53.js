import {handleAdmin as handleAdminV52,runPhase7AndEarlierScheduled} from './admin-api-v52.js';
import {adminHtml} from './admin-ui-v53.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v53-pages-clickable';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV52(request,env);
}
