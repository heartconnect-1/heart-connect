import {handleAdmin as handleAdminV48,runPhase7AndEarlierScheduled} from './admin-api-v48.js';
import {adminHtml} from './admin-ui-v49.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v49';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV48(request,env);
}
