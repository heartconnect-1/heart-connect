import {handleAdmin as handleAdminV43,runPhase7AndEarlierScheduled} from './admin-api-v43.js';
import {adminHtml} from './admin-ui-v44.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v44';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV43(request,env);
}
