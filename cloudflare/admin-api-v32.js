import {handleAdmin as handleAdminV31,runPhase7AndEarlierScheduled} from './admin-api-v31.js';
import {adminHtml} from './admin-ui-v32.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v32';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV31(request,env);
}
