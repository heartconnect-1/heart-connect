import {handleAdmin as handleAdminV26,runPhase7AndEarlierScheduled} from './admin-api-v26.js';
import {adminHtml} from './admin-ui-v27.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v27';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV26(request,env);
}
