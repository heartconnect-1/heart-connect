import {handleAdmin as handleAdminV30,runPhase7AndEarlierScheduled} from './admin-api-v30.js';
import {adminHtml} from './admin-ui-v31.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v31';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV30(request,env);
}
