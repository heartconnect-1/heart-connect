import {handleAdmin as handleAdminV38,runPhase7AndEarlierScheduled} from './admin-api-v38.js';
import {adminHtml} from './admin-ui-v39.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v39';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV38(request,env);
}
