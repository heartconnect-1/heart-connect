import {handleAdmin as handleAdminV12,runPhase7AndEarlierScheduled} from './admin-api-v12.js';
import {adminHtml} from './admin-ui-v13.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v13';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV12(request,env);
}
