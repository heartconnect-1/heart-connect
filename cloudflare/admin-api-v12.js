import {handleAdmin as handleAdminV11,runPhase7AndEarlierScheduled} from './admin-api-v11.js';
import {adminHtml} from './admin-ui-v12.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v12';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV11(request,env);
}
