import {handleAdmin as handleAdminV50,runPhase7AndEarlierScheduled} from './admin-api-v50.js';
import {adminHtml} from './admin-ui-v50.js';

export {runPhase7AndEarlierScheduled};
export const VERSION='hc-admin-control-plane-v51';
...
export async function handleAdmin(request,env){
  ...
  return handleAdminV50(request,env);
}
